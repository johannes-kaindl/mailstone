...
export const en = {
  ...
  "error.command.tasknotes-unavailable": "TaskNotes is not available, or it rejected the task's shape.",
...
export const de: typeof en = {
  ...
  "error.command.tasknotes-unavailable": "TaskNotes ist nicht verfügbar, oder die Formprüfung der Aufgabe ist durchgefallen.",
