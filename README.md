...
**Status: pre-release — M1 (scaffold + offline format layer) complete; M2 (SMTP transport, accounts, calendar-notes bridge) complete; M3 (IMAP sync) not started.** No installable release exists yet.
